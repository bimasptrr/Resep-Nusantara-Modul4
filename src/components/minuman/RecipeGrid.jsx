            ...
            >
              <div className="relative bg-white/15 backdrop-blur-xl border border-white/25 rounded-2xl md:rounded-3xl overflow-hidden shadow-lg md:shadow-2xl shadow-green-500/5 hover:shadow-green-500/15 transition-all duration-500 group-hover:scale-105 group-hover:bg-white/20">
                ...
                <div
                  ...
                  onClick={() => onSelectRecipe && onSelectRecipe(recipe.id, 'minuman')}
                >
                  <img
                ...
                <div className="relative z-10 p-4 md:p-6">
                  <div className="flex items-center justify-between mb-3">
                    <span className="text-xs font-semibold text-green-700 bg-green-100/90 px-2 py-1 rounded-full">
                      Minuman
                    </span>
                  ...
                  <h3 className="font-bold text-slate-800 mb-3 text-base md:text-lg group-hover:text-green-600 transition-colors duration-200 line-clamp-2">
                    {recipe.name}
                  </h3>
                  ...
                  <div className="flex justify-between mt-2">
                    ...
                    <button
                      onClick={() => onSelectRecipe && onSelectRecipe(recipe.id, 'minuman')}
                      className="flex items-center gap-1 px-3 py-1 rounded-lg text-sm bg-green-500 text-white hover:bg-green-600 transition-colors duration-200"
                    >
